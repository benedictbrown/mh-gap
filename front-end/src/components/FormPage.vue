<template>
  <b-form id="FormPage" action="/submit" enctype="multipart/form-data">
    ...
    <b-form-group v-show="step === 2">
      ...
      <div>
        <p>
          Assess signs and symptoms of delirium due to an acute physical condition, e.g. infection, celebral malaria,
          dehydration, metabolic abnormalities (such as hypoglycaemia or hyponatraemia); or medication side effects,
          e.g. due to some antimalarial
    ...
    <b-form-group v-show="step === 5">
      ...
      <div>
        ...
        enough to interfere significantly with work and social activities or requiring confinement or hospitalization:
        <br>
        <ul>
    ...
    <b-form-group v-show="step === 7">
      ...
      <div>Does the person have at least two of the following:
        ...
        <ul>
          ...
          <li>
            Disorganized speech and/or behaviour, e.g. incoherent/irrelevant speech such as mumbling or laughing to
            self, strange appearance, signs of self-neglect or appearing unkempt
          </li>
        </ul>
      </div>
      <div>
